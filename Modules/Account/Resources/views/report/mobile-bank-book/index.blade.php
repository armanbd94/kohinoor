                        ...
                        <table class="table table-bordered" style="width:100%;">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="text-cnter">Warehouse</th>
                            ...
                            <tfoot>
                                <tr class="bg-primary">
                                    <td colspan="6" class="text-right text-white font-weight-bolder">Total</td>
...
if(bank_acc_id){
    $.ajax({
        ...
        type:"POST",
        data:{start_date:start_date,end_date:end_date,bank_acc_id:bank_acc_id,bank_name:bank_name,warehouse_id:warehouse_id,_token:_token},

...
class CreditCustomer extends BaseModel
{
    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        $this->column_order = ['c.id','c.name', 'c.shop_name','c.address','c.mobile','c.upazila_id','c.route_id','c.customer_group_id',null];
    ...
    public function count_all()
    {
        ...
        ->groupBy('c.id','b.id')
        ->having('balance','>',0)
        ->where('c.district_id', Auth::guard('asm')->user()->district_id)->get()->count();
    }
    /******************************************

...
class CustomerAdvance extends BaseModel
{
    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        $this->column_order = ['transactions.id','c.name', null,null,'transactions.created_at',null];
        ...
        ->where(['c.district_id'=> Auth::guard('asm')->user()->district_id,'transactions.voucher_type'=>self::TYPE]);
    ...
    public function count_all()
    {
        ...
        ->join('chart_of_accounts as coa','transactions.chart_of_account_id','=','coa.id')
        ->join('customers as c','coa.customer_id','c.id')
        ->where(['c.district_id'=> Auth::guard('asm')->user()->district_id,'transactions.voucher_type'=>self::TYPE])->get()->count();
    }
    /******************************************

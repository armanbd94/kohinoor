...
class Customer extends BaseModel
{
    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        $this->column_order = ['id','name', 'shop_name', 'mobile', 'customer_group_id','upazila_id','route_id', 'postal_code','status',null,null];
        
        
        $query = self::with('customer_group','upazila','route')->where('district_id',Auth::guard('asm')->user()->district_id);
    ...
    {
        return self::toBase()->where('district_id',Auth::guard('asm')->user()->district_id)->get()->count();
    }
    /******************************************

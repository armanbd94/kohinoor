...
class TodaysCustomerReceipt extends BaseModel
{
    ...
    *******************************************/
    private function get_datatable_query()
    {
        ...
        $query = self::select('transactions.*','coa.id as coa_id','coa.code','coa.name','coa.parent_name','c.id as customer_id','c.shop_name','c.name as customer_name')
        ...
        ->where([
            ...
            ['transactions.warehouse_id',Auth::guard('asm')->user()->warehouse_id],

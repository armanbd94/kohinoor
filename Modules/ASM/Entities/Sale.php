...
class Sale extends BaseModel
{
    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        $this->column_order = ['id','memo_no','salesmen_id',  'custoemr_id', 'total_item', 'total_price', 'order_discount','total_labor_cost','order_tax_rate', 'order_tax',
        ...
        $query = self::with('salesmen','customer')->where(['warehouse_id' => Auth::guard('asm')->user()->warehouse_id,'asm_id' => Auth::guard('asm')->user()->id]);
    ...
    {
        return self::toBase()->where(['warehouse_id' => Auth::guard('asm')->user()->warehouse_id,'asm_id' => Auth::guard('asm')->user()->id])->get()->count();
    }
    /******************************************

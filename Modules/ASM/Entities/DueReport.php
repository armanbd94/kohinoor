...
class DueReport extends BaseModel
{
    ...
    *******************************************/
    ...
    private function get_datatable_query()
    {
        ...
        $this->column_order = ['s,id','s.sale_date', 's.memo_no','s.customer_id','s.grand_total','s.previous_due','s.paid_amount','s.due_amount'];
        ...
        ->where([
            ['s.warehouse_id',Auth::guard('asm')->user()->warehouse_id],
            ['s.asm_id',Auth::guard('asm')->user()->id],
            ['s.payment_status','<>',1]
        ]);
        //search query

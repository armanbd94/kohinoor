                ...
                <div class="card-toolbar">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" style="">
                            <a class="dropdown-item" href="{{ url('asm/customer') }}">Customer</a>
                            <a class="dropdown-item" href="{{ url('asm/customer-ledger') }}">Customer Ledger</a>
                            <a class="dropdown-item" href="{{ url('asm/paid-customer') }}">Paid Customer</a>
                            <a class="dropdown-item" href="{{ url('asm/customer-advance') }}">Customer Advance</a>
                        </div>
                    </div>
                    <!--end::Button-->
                </div>
                    ...
                    <div class="row">
                        <x-form.selectbox labelName="Customer" name="customer_id" col="col-md-4" class="selectpicker">
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{ $customer->id }}">{{ $customer->name.' - '.$customer->mobile.' ('.$customer->shop_name.')' }}</option>
                            @endforeach
                            @endif
                        </x-form.selectbox>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="dataTable" class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr class="bg-primary">
                                        <th style="text-align: right !important;font-weight:bold;" colspan="8">Total</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('asm.credit.customer.datatable.data')}}",
                "type": "POST",
                "data": function (data) {

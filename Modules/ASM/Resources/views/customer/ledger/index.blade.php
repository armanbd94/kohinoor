                ...
                <div class="card-toolbar">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" style="">
                            ...
                            <a class="dropdown-item" href="{{ url('asm/credit-customer') }}">Credit Customer</a>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="dataTable" class="table table-bordered table-hover">
                                ...
                                <tfoot>
                                    <tr class="bg-primary">
                                        <th style="text-align: right !important;font-weight:bold;" colspan="3">Total</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('asm.customer.ledger.datatable.data')}}",
                "type": "POST",
                "data": function (data) {

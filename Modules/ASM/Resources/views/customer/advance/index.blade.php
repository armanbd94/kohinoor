...
@include('asm::customer.advance.modal')
@endsection
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('asm.customer.advance.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('asm.customer.advance.store.or.update')}}";
        ...
        $(document).on('click', '.edit_data', function () {
            ...
            if (id) {
                $.ajax({
                    url: "{{route('asm.customer.advance.edit')}}",
                    type: "POST",
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('asm.customer.advance.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('asm.customer.advance.bulk.delete')}}";

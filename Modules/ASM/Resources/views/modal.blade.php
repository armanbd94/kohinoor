            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <x-form.textbox labelName="Username" name="username" required="required" col="col-md-12" placeholder="Enter username"/>
                        <x-form.textbox labelName="Phone No." name="phone" required="required" col="col-md-12" placeholder="Enter phone number"/>
                        <x-form.textbox labelName="Email" name="email" col="col-md-12" placeholder="Enter email"/>
                        ...
                        <x-form.selectbox labelName="District" name="district_id" col="col-md-12" class="selectpicker">

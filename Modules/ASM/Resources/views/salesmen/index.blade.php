...
@include('asm::salesmen.modal')
@include('asm::salesmen.view')
@endsection
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('asm.sales.representative.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url      = "{{route('asm.sales.representative.store.or.update')}}";
    ...
    $(document).on('click', '.edit_data', function () {
        ...
        if (id) {
            $.ajax({
                url: "{{route('asm.sales.representative.edit')}}",
                type: "POST",
    ...
    $(document).on('click', '.view_data', function () {
        ...
        if (id) {
            $.ajax({
                url: "{{route('asm.sales.representative.view')}}",
                type: "POST",
                data: { id: id,_token: _token},
                success: function (data) {
...
function upazilaRouteList(upazila_id,salesmen_id='')
{
    if(upazila_id)
    {
        ...
        $.ajax({
            url:"{{ route('asm.sales.representative.upazila.route.list') }}",
            type:"POST",

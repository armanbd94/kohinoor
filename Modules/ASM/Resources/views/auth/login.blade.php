...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="css/pages/login/classic/login-9.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		<div class="container-fluid m-0 p-0">
			<div class="row m-0 p-0">
				<div class="col-md-8 d-none d-lg-block d-xl-block"  style="background: #f1c86c;">
					...
					<div class="card w-100" style="border: 0;">
						<div class="card-body">
							...
							<div style="width: 80%;margin:0 auto;">
								...
								@endif
								<form class="form" action="{{ url('asm-login') }}" method="POST">
									@csrf

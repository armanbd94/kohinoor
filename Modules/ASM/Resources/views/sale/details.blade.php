                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td width="50%" class="text-right">
                                            <h4 class="name m-0">{{ $sale->memo_no }}</h4>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        @if (!$sale->sale_products->isEmpty())
                                            @foreach ($sale->sale_products as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">{{ $item->product->product_name.' '.$item->size->size.$item->size->unit->unit_name }}</td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                                    {{ number_format($sale->total_labor_cost,2) }} {{ config('settings.currency_symbol') }}
                                                @else 
                                                    {{ config('settings.currency_symbol') }} {{ number_format($sale->total_labor_cost,2) }}
                                                @endif
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="4"></td>
                                            <td colspan="2"  class="text-right">PREVIOUS DUE</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:left;">
                                                <p style="margin:0;padding:0;"><b class="text-uppercase">{{ $sale->created_by }}</b>
                                                    <br> {{ date('d-M-Y h:i:s A',strtotime($sale->created_at)) }}</p>
                                        ...
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;margin:0 auto;">
                                                <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $sale->authorized_by }}</b></p>
                                                <p class="dashed-border"></p>
                                        ...
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;">
                                                <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase">{{ $sale->received_by }}</b></p>
                                                <p class="dashed-border"></p>

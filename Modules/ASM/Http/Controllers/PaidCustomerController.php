...
use Modules\ASM\Entities\PaidCustomer;
...
class PaidCustomerController extends BaseController
{
    ...
    {
        $this->setPageData('Paid Customer','Paid Customer','fas fa-users',[['name'=>'Customer','link'=>route('asm.customer')],['name'=>'Paid Customer']]);
        $customers = $this->paid_customers();
        return view('asm::customer.paid-customer.index',compact('customers'));
    }

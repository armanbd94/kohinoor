          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="Zip Code" name="zip" col="col-md-6" placeholder="Enter zip code"/>
                    <x-form.textbox labelName="Country" name="country" col="col-md-6" placeholder="Enter country"/>
                    <x-form.textbox labelName="Previous Balance" name="previous_balance" col="col-md-6" class="text-right" placeholder="Previous balalnce"/>

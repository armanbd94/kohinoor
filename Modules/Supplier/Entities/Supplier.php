...
{
    protected $fillable = [ 'name', 'company_name', 'mobile', 'email', 'phone', 'city', 'state', 'zip', 'country', 'address', 'details', 'status', 'created_by', 'modified_by'];
    ...
    **************************************/
    ...
    protected const ACTIVE_SUPPLIERS = '_active_suppliers';
    ...
    public static function activeSuppliers(){
        return Cache::rememberForever(self::ACTIVE_SUPPLIERS, function () {
    ...
    public static function flushCache(){
        ...
        Cache::forget(self::ACTIVE_SUPPLIERS);
    }

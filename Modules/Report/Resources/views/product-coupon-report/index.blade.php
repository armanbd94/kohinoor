                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        <th>Sl</th>
                                        <th>Product Name</th>
                                        <th class="text-right">Total Coupon Generated</th>
                                        <th class="text-right">Total Coupon Used</th>
                                        <th class="text-right">Total Coupon Remaining</th>
                                        <th class="text-right">Coupon Price</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('product.coupon.report.data')}}",
                "type": "POST",
                "data": function (data) {

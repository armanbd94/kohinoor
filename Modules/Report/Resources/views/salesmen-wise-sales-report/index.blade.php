            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Salesmen" name="salesmen_id" col="col-md-4" class="selectpicker">
                            @if (!$salesmen->isEmpty())
                                @foreach ($salesmen as $value)
                                    <option value="{{ $value->id }}">{{ $value->name.' - '.$value->phone.' ('.$value->upazila->name.', '.$value->district->name.')' }}</option>
                                @endforeach
                            @endif
                        </x-form.selectbox>
                        <x-form.selectbox labelName="Warehouse" name="warehouse_id"  col="col-md-4" class="selectpicker" onchange="closing_data(this.value)">
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('salesmen.wise.sales.report.datatable.data')}}",
                "type": "POST",
                "data": function (data) {

...
<div class="col-md-12 mb-5">
    <div class="card card-custom card-border">
        ...
        <div class="card-body">
            ...
            @if($total_stock_value > 0)<h5>{{ numberTowords($total_stock_value) }} Taka</h5>@endif
        </div>
    </div>
</div>
...
<div class="col-md-12 mb-5">
    <div class="card card-custom card-border">
        ...
        <div class="card-body">
            ...
            @if($total_damage_value > 0)<h5>{{ numberTowords($total_damage_value) }} Taka</h5>@endif
        </div>
    </div>
</div>
...
<div class="col-md-12 mb-5">
    <div class="card card-custom card-border">
        ...
        <div class="card-body">
            ...
            @if($collection_transfer_value > 0)<h5>{{ numberTowords($collection_transfer_value) }} Taka</h5>@endif
        </div>
    </div>
</div>
...
<div class="col-md-12 mb-5">
    <div class="card card-custom card-border">
        ...
        <div class="card-body">
            ...
            @if($warehouse_expense > 0)<h5>{{ numberTowords($warehouse_expense) }} Taka</h5>@endif
        </div>
    </div>
</div>

        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showStoreFormModal('Add New Raw Material','Save')" class="btn btn-primary btn-sm font-weight-bolder"> 
...
@include('material::material.modal')
@include('material::material.view-modal')
@endsection
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "columnDefs": [{
                ...
                {
                    @if (permission('material-bulk-delete'))
                    "targets": [1,2,4,5,7,8,9,10,11,12,13],
                    @else 
                    "targets": [0,1,3,4,6,7,8,9,10,11,12],
                    @endif
                    "className": "text-center"
                },
                {
            ...
            "buttons": [
                ...
                },
                {
                    ...
                    "exportOptions": {
                        @if (permission('material-bulk-delete'))
                        columns: ':visible:not(:eq(0),:eq(2),:eq(14))' 
                        @else 
                        columns: ':visible:not(:eq(1),:eq(13))' 
                        @endif
                    },
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #purchase_price').val(data.purchase_price);
        ...
        $(document).on('click','#generate-code',function(){
            // var barcode_symbology = $('#barcode_symbology option:selected').val();
            ...
            // }else{
            //     notification('error','Please select barcode symbology!');
            // }
        });

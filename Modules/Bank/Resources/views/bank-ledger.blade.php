        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="From Date" name="from_date" class="date" col="col-md-3" />
                        <x-form.textbox labelName="To Date" name="to_date" class="date" col="col-md-3" />
...
$(document).ready(function(){
    ...
    $(document).on('click','#btn-reset',function(){
        ...
        $('#to_date').val('');
        $('#bank_name').val('');
        $('#bank_name .selectpicker').selectpicker('refresh');
        $('#bank-ledger-table tbody').html('');
    });

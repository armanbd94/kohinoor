    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function (data) {
                ...
                data.from_warehouse_id = $("#form-filter #from_warehouse_id option:selected").val();
                data.to_warehouse_id   = $("#form-filter #to_warehouse_id option:selected").val();
                data.transfer_status   = $("#form-filter #transfer_status option:selected").val();
                data._token            = _token;
            }
        },
        "columnDefs": [{

                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td width="30%" class="text-right">
                                            ...
                                            <div class="m-0 date"><b>Transfer Status:</b>{{ $transfer->transfer_status ? TRANSFER_STATUS[$transfer->transfer_status] : 'N/A' }}</div>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;">
                                                <p style="margin:0;padding:0;"><b class="text-uppercase">{{ $transfer->asm->name }}</b></p>
                                                <p class="dashed-border"></p>

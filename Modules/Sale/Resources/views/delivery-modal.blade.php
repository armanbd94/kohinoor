          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="Authorized By" name="authorized_by" required="required" col="col-md-12"/>
                    <x-form.textbox labelName="Received By" name="received_by" required="required" col="col-md-12"/>
                </div>
            </div>
            <!-- /modal body -->
